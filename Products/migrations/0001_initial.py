# Generated by Django 3.2.15 on 2022-09-07 18:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_on', models.DateTimeField(default=datetime.datetime(2022, 9, 7, 18, 41, 33, 82390))),
                ('category_id_fk', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Products.category')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_on', models.DateTimeField(default=datetime.datetime(2022, 9, 7, 18, 41, 33, 66766))),
                ('category_id_fk', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Products.category')),
                ('prod_id_fk', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Products.product')),
                ('user_id_fk', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
